var arrLang = {
    ...
    "KEYWORDS": "droit de la famille avec un avocat en ligne, divorce amiable, séparation à l'amiable pour couple marié et non-marié, garde d'enfants, annulation de la pension alimentaire, service d'aide à l'homologation, contrat de vie commune",

    "DESCRIPTION": "LégalQC offre des services en droit de la famille avec un avocat en ligne à des tarifs avantageux. Les services juridiques disponibles en droit de la famille en ligne sont: divorce amiable, séparation à l'amiable pour couple marié et non-marié, garde d'enfants, annulation de la pension alimentaire, service d'aide à l'homologation, contrat de vie commune. Les services juridiques en ligne en droit de la famille de LégalQC permettent aux clients de gagner du temps et de l'argent ainsi qu'une meilleure accès à la justice grâces à des technologies innovantes. LégalQC est dédié à offrir des services juridiques en droit de la famille en ligne avec des tarifs abordables et à la portée de tous.",
